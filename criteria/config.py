class Config(object):
    ...
    backbone = 'resnet50'
    classify = 'softmax'
    num_classes = 'TODO: set classes within train script.' # set number of classes dynamically 
    ...
    load_model_path = '../pretrained_models/resnet18.pth'
    test_model_path = '../checkpoints/resnet18_110.pth'
    save_interval = 10

    train_batch_size = 1 # 16  # batch size
    test_batch_size = 60
